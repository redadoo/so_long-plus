...
/*   Updated: 2023/05/12 16:10:46 by evocatur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	program.man.step.pos.x = 95;
	program.man.step.pos.y = program.window.size.y + 20;
	program.man.coin.pos.x = 95;
	program.man.coin.pos.y = program.window.size.y + 50;
